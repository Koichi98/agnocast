...
def calc_action_delays(config: dict) -> tuple:
    ...
    # launch_testing aborts the run if ReadyToTest is not reached within ~15s,
    # so it must always fire promptly. In stress mode the soak is done in
    # Test1To1.setUpClass instead of delaying ReadyToTest.
...
class Test1To1(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # running under load. ReadyToTest fires promptly (see calc_action_delays)
