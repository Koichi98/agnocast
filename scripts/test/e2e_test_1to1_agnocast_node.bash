...
# End-to-end 1-to-1 test runner for agnocast::Node (the pure-Agnocast node).
# Runs the 1-to-1 launch test, in which standalone executables built on
...
TEST_FILE="src/agnocast_e2e_test/test/functional/test_agnocast_node_1to1_launch.py"
...
echo "agnocast::Node 1-to-1 e2e test passed!!" | sudo tee /dev/kmsg
